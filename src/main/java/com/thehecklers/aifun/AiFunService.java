...
import com.thehecklers.aifun.data.CompletionRequest;
import com.thehecklers.aifun.data.EventData;
...
@Service
public class AiFunService {
    private final Logger logger = LoggerFactory.getLogger(AiFunService.class);

    private final String prompt = """
            Who was the best Spock among all the actors who have played him?
            """;
